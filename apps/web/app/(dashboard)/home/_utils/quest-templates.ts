...
const TASK_TEMPLATES = [
  ...
  {
    titleFn: (g: string) => `Reflect: ${g} Fundamentals`,
    type: 'reflection', xp: 25, rarity: 'common' as const, mins: 10,
    descFn: (g: string) => `Reflect on ${g} fundamentals. Think about how these concepts apply to your learning journey.`,
    objectivesFn: (g: string) => [
      `Reflect on ${g} fundamentals`,
      'Note key takeaways',
      'Try one technique on your own',
    ],
    aiTipFn: (g: string) => `After reflecting, try to explain what you learned in your own words. This is called "active recall" — it makes ${g} concepts stick 10x better!`,
    funFactFn: (g: string) => `Reflection is one of the most powerful learning tools. Studies show that reflecting on ${g} concepts solidifies understanding by up to 40%!`,
    checkQuestionFn: (g: string) => `After reflecting on ${g} fundamentals, what should you do first?`,
    checkOptions: ['Move to the next topic', 'Try to recreate what was shown', 'Take a break for the day', 'Write down key insights'],
    checkCorrect: 1,
  },
  {
